...
#define PIN_WIRE_SDA (6) // P1.04
#define PIN_WIRE_SCL (8) // P0.11
#define PIN_DISPLAY_EN (31) // 31
...
// Button
#define BUTTON_PIN (9 + 0) // P1.00

// GPS
#define GPS_TX_PIN (0 + 2) // P0.20 - This is data from the MCU
#define GPS_RX_PIN (32 + 15) // P0.22 - This is data from the GNSS

#define PIN_GPS_EN (0 + 29) // P0.24
#define GPS_UBLOX
// define GPS_DEBUG
...
#define PIN_SERIAL2_RX (0 + 30) // P0.06
#define PIN_SERIAL2_TX (0 + 2) // P0.08

// Serial interfaces
#define SPI_INTERFACES_COUNT 1

#define PIN_SPI_MISO (0 + 22)   // P0.02
#define PIN_SPI_MOSI (0 + 20) // P1.15
#define PIN_SPI_SCK (0 + 24)  // P1.11

#define LORA_MISO PIN_SPI_MISO
#define LORA_MOSI PIN_SPI_MOSI
#define LORA_SCK PIN_SPI_SCK
#define LORA_CS (0 + 17) // P1.13
...
// SX126X CONFIG
#define SX126X_CS (0 + 17)      // P1.13 FIXME - we really should define LORA_CS instead
...
#define SX126X_BUSY (32 + 0)     // P0.29
#define SX126X_RESET (32 + 13)     // P0.09
#define SX126X_RXEN RADIOLIB_NC     // P0.17
#define SX126X_TXEN (32 + 11)  // Assuming that DIO2 is connected to TXEN pin. If not, TXEN must be connected.
